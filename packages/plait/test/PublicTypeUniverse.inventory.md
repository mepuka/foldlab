...
| `FabricClient.ConnectionBootstrap` | `src/internal/transport.ts` | debt-with-a-ticket | `DEV-763` | stage 4: consume the shared generated-core candidate form through KernelDoor |
| `FabricClient.ConnectionCredential` | `src/internal/transport.ts` | debt-with-a-ticket | `DEV-763` | stage 4: consume the shared generated-core candidate form through KernelDoor |
