 ...
 * `*.generated.ts` projections, whose bytes are the model's and are held to a
 * byte-identical regeneration by `check:kernel-schemas`, `check:kernel-tables`,
 * and `check:kernel-builder`. Anything else that ships is swept.
 */
