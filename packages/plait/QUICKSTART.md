...
Sections that say “design only” remain sketches. E2 and E4 are runnable from
this workspace package: lanes own partition streams, durable folds resume from
anchors, and `plait chaos` measures hard-kill and protocol-redelivery schedules.
