 ...
 * a candidate — the CLI, the fabric client, the daemon — takes this service
 * and calls `admit`; a private validator anywhere else is a second door and a
 * drift surface. The implementation behind the seam is the shipped door
