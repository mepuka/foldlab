 ...
 *
 * **No door ships in this package.** What ships here is the type of one: a
 * hand-written implementation is checked verdict-for-verdict against the
 * model's emitted admission vectors, which is what makes a runtime door worth
 * trusting. Conformance to those vectors is agreement with the model, never a
 * runtime guarantee promoted out of it.
 *
