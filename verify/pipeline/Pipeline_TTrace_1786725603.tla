---- MODULE Pipeline_TTrace_1786725603 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("Pipeline_TTrace_1786725603.json", _TETrace)
...
\*
\*trace == IODeserialize("Pipeline_TTrace_1786725603.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG Pipeline_TTrace_1786725603 ----
CONSTANTS
    Rule = "snapshot"
...
ALIAS
    _expression
=============================================================================
\* Generated on Fri Aug 14 11:40:04 CDT 2026