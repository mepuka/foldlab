---- MODULE Pipeline_TTrace_1786725522 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("Pipeline_TTrace_1786725522.json", _TETrace)
...
\*
\*trace == IODeserialize("Pipeline_TTrace_1786725522.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG Pipeline_TTrace_1786725522 ----
CONSTANTS
    Rule = "shipped"
...
ALIAS
    _expression
=============================================================================
\* Generated on Fri Aug 14 11:38:43 CDT 2026