---- MODULE Pipeline_TTrace_1786725602 ----
...
_inv ==
    ~(
        ...
        /\
        phase = ([o1 |-> "replied", o2 |-> "facted"])
        /\
        journal = (<<[op |-> "o1", kind |-> "fact"], [op |-> "o1", kind |-> "bridge"], [op |-> "o2", kind |-> "fact"]>>)
        /\
        lock = ("o2")
        /\
        reply = ([o1 |-> [seq |-> 1, head |-> 3], o2 |-> [seq |-> 0, head |-> 0]])
    )
----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("Pipeline_TTrace_1786725602.json", _TETrace)
...
\*
\*trace == IODeserialize("Pipeline_TTrace_1786725602.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([phase |-> [o1 |-> "bridged", o2 |-> "start"],journal |-> <<[op |-> "o1", kind |-> "fact"], [op |-> "o1", kind |-> "bridge"]>>,lock |-> "none",reply |-> [o1 |-> [seq |-> 0, head |-> 0], o2 |-> [seq |-> 0, head |-> 0]]]),
    ([phase |-> [o1 |-> "bridged", o2 |-> "certified"],journal |-> <<[op |-> "o1", kind |-> "fact"], [op |-> "o1", kind |-> "bridge"]>>,lock |-> "none",reply |-> [o1 |-> [seq |-> 0, head |-> 0], o2 |-> [seq |-> 0, head |-> 0]]]),
    ([phase |-> [o1 |-> "bridged", o2 |-> "facted"],journal |-> <<[op |-> "o1", kind |-> "fact"], [op |-> "o1", kind |-> "bridge"], [op |-> "o2", kind |-> "fact"]>>,lock |-> "o2",reply |-> [o1 |-> [seq |-> 0, head |-> 0], o2 |-> [seq |-> 0, head |-> 0]]]),
    ([phase |-> [o1 |-> "replied", o2 |-> "facted"],journal |-> <<[op |-> "o1", kind |-> "fact"], [op |-> "o1", kind |-> "bridge"], [op |-> "o2", kind |-> "fact"]>>,lock |-> "o2",reply |-> [o1 |-> [seq |-> 1, head |-> 3], o2 |-> [seq |-> 0, head |-> 0]]])
    >>
----
...
---- CONFIG Pipeline_TTrace_1786725602 ----
CONSTANTS
    Rule = "shipped"
...
ALIAS
    _expression
=============================================================================
\* Generated on Fri Aug 14 11:40:03 CDT 2026