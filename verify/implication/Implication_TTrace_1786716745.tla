---- MODULE Implication_TTrace_1786716745 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("Implication_TTrace_1786716745.json", _TETrace)
...
\*
\*trace == IODeserialize("Implication_TTrace_1786716745.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG Implication_TTrace_1786716745 ----
CONSTANTS
    MaxLen = 4
    Rule = "sorted"
...
ALIAS
    _expression
=============================================================================
\* Generated on Fri Aug 14 09:12:25 CDT 2026