---- MODULE Replay_TTrace_1786730267 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("Replay_TTrace_1786730267.json", _TETrace)
...
\*
\*trace == IODeserialize("Replay_TTrace_1786730267.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG Replay_TTrace_1786730267 ----
CONSTANTS
    Guard = "faithless"
    MaxFence = 3
...
ALIAS
    _expression
=============================================================================
\* Generated on Fri Aug 14 12:57:47 CDT 2026