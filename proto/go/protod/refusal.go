...
const (
	...
	RefusalSortGrammarDigest = "b48c29004d0bc5794c8431b4e2eb7f85557a31da6a8293373118fbb1e67ba072"
)
...
const (
	...
	KindCompactionBlocked = "compaction-blocked" // required refusal-corpus evidence is absent
)
...
func classifyRefusal(r *Refusal) *Refusal {
