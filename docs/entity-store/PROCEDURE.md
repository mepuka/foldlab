...
| `LEDGER.md` | the machine-extracted proved ledger, both sides (landed 2026-08-25, worktree 5; the W3-4 promise-status join still owed) | the mechanical statement of what is proved and gated | REGENERATED only (`mise run gen`); hand edits are violations the diff catches | generated; banner line 1 |
