...
linearizability. This bound follows from `catalog-r4/D2`'s sequential
schedule shape and the external review's weakened C5 verdict
(`docs/research/2026-08-13-external-review-findings.md`). This
