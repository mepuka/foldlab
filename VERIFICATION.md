...
NATS subjects. Its twelve classified domain refusal kinds are total over two ontological sorts:
...
The TypeScript suites, the Go conformance suite, the shared all-twelve refusal
